 ...
 * AWS_ACCESS_KEY_ID     Fake key id              (default: so3testkey000000)
 * AWS_SECRET_ACCESS_KEY Fake secret              (default: so3testsecret0000000000000000000)
 *
...
const headMs = new Trend('s3_head_ms', true) // unsigned http HEAD (not in jslib S3Client)
...
export default async function () {
  ...
  // headObject is not part of the k6 jslib S3Client API, so SO3 is checked
  // through its unsigned S3-like HEAD path.
  t = Date.now()
  {
